...
class Human(Player):
    ...
    def bet(self):
        ...
        print(f"MY bet {self.bet_coin} coin(s) to {self.bet_cell}.")
...
# Add C1's bet as per your example
human_player.bets['1'] = 9
print(f"C1 bet {human_player.bets['1']} coin(s) to 1.")

print("|_____|MY|C1|C2|C3|")
print("|R(×2)|00|00|00|00|")
print("|B(×2)|00|00|00|00|")
print("|1(x8)|00|09|00|00|")
print("|2(x8)|30|00|00|00|")
print("|3(x8)|00|00|00|00|")
print("|4(x8)|00|00|00|00|")
print("|5(x8)|00|00|00|00|")
print("|6(x8)|00|00|00|00|")
